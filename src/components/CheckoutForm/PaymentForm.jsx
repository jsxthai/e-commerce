...
const PaymentForm = ({ checkoutToken, shippingData, backStep, onCaptureCheckout, nextStep }) => {
    ...
    const handleSubmit = async (e, elements, stripe) => {
        ...
        const { error, paymentMethod } = await stripe.createPaymentMethod({ type: 'card', card: cartElement });
                    ...
                    {({ elements, stripe }) => (
                        <form onSubmit={(e) => handleSubmit(e, elements, stripe)}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <Button variant='contained' type='submit' disable={!stripe} color='primary'>
